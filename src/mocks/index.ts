export const mockData = [
  {
    ...
    detail: {
      ...
      location: "1.28692,103.85457 Merlion",
    },
  },
  {
    lat: 1.287466,
    ...
    key: 1,
    detail: {
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Asian_civilisations_museums_singapore.jpg/1280px-Asian_civilisations_museums_singapore.jpg",
      urlWeb: "https://www.nhb.gov.sg/acm/",
      description: `ACM is Singapore’s national museum of Asian antiquities and decorative art. As the only museum in Asia with a pan-Asian scope, ACM is devoted to exploring the rich artistic heritage of Asia through our outstanding collection of masterpieces, and through ground-breaking special exhibitions. ACM focuses on the many historical connections between cultures and civilisations in Asia, and between Asia and the world.
      ...
      location: "1.287466,103.851424 Asian Civilisations Museum",
    },
  },
  {
    lat: 1.290555,
  ...
  },
  {
    ...
    key: 4,
    detail: {
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Presenting..._the_real_ION_%288200217734%29.jpg/1280px-Presenting..._the_real_ION_%288200217734%29.jpg",
      urlWeb: "https://en.wikipedia.org/wiki/Orchard_Road",
      description: `Orchard Road, often known colloquially as simply Orchard, is a major 2.5 km (1.6 mi)–long road in the Central Area of Singapore.[4] Known as a famous tourist attraction, it is an upscale shopping area of Singapore, with numerous internationally renowned department stores, restaurants and coffeehouses located in its vicinity.[4]
      ...
      location: "1.302279,103.837399 Orchard Road",
    },
  },
  {
    lat: 1.283099,
    ...
    key: 5,
    detail: {
      image: "https://www.marinabaysands.com/content/dam/singapore/marinabaysands/master/main/home/mbs-exterior-view-daylight-1920x595.jpg",
      urlWeb: "https://id.marinabaysands.com/",
      description: `Marina Bay Sands is the leading business, leisure and entertainment destination in Asia. The vision was to build an integrated development that is timeless, and a landmark that possesses a distinct identity which distinguishes Singapore from other cities.
      ...
      Sheldon G. Adelson, Founder, Las Vegas Sands Corp.`,
      location: "1.283099,103.860295 Marina Bay Sands",
    },
  },
  {
    lat: 1.28179,
    ...
    key: 6,
    detail: {
      image: "https://upload.wikimedia.org/wikipedia/commons/0/0d/Marina_Bay_Sands_from_Gardens_By_The_Bay.jpg",
      urlWeb: "https://en.wikipedia.org/wiki/Gardens_by_the_Bay",
      description: `The Gardens by the Bay is a nature park spanning 101 hectares (250 acres) in the Central Region of Singapore, adjacent to the Marina Reservoir. The park consists of three waterfront gardens: Bay South Garden (in Marina South), Bay East Garden (in Marina East) and Bay Central Garden (in Downtown Core and Kallang).[2] The largest of the gardens is the Bay South Garden at 54 hectares (130 acres) designed by Grant Associates. Its Flower Dome is the largest glass greenhouse in the world.[3]
      ...
      location: "1.28179,103.863954 Gardens By The Bay",
    },
  },
  {
    lat: 1.2845118979830603,
    lng: 103.84363250120009,
    label: "Chinatown",
    isSelected: false,
    key: 7,
    detail: {
      image: "https://chinatown.sg/wp-content/uploads/2020/06/living-quarter.jpg",
      urlWeb: "https://chinatown.sg/",
      description: "In his 1822 Master Town Plan, Sir Stamford Raffles allocated the whole area west of the Singapore River for a Chinese settlement known as the Chinese Campong, envisaging that Chinese would form the bulk of future town dwellers. Singapore, the new land of opportunity then, had attracted many Chinese immigrants, who expanded the original boundaries of this economically and culturally vibrant, self-contained town. This self-contained kampong (community settlement) became home to many Chinese immigrants, and a transit point for coolies (unskilled labourers) going to Malaya.",
      location: "1.2845118979830603,103.84363250120009 Chinatown",
    },
  },
];
